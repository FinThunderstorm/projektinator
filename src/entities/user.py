...
class User:
    ...
    def __init__(self,
        ...
        Args:
            uid (str): holds user's id in database, needs to be unique,
                is in uuid4 format generated by database
            username (str): username is unique, required string that
                hold's user's username
    ...
    def __str__(self) -> str:
        ...
        pw_hash_ok = bool(self.password_hash[:len('pbkdf2:sha256:260000$')] ==
        ...
        return (f'User ”{self.fullname} ({self.username})”\n'
                ...
                f' - users role ”{self.user_role_name}”\n'
